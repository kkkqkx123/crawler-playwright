...
登录页面是其中的子部分，url为https://accounts.douban.com/passport/login_popup?login_source=anony

验证码页面url为https://turing.captcha.gtimg.com/1/template/drag_ele.html

工作流：1.点击密码登录控件(否则默认是手机激活码) 2.输入账号、密码3.点击登录控件4.点击登录控件后出现滑块人机验证，通过滑块控件让待滑动块移动到背景中的目标位置

密码登录控件

<li class="account-tab-account">密码登录</li>
selector：#app > div > div.account-body-tabs > ul.tab-start > li.account-tab-account
xpath：//*[@id="app"]/div/div[1]/ul[1]/li[2]

点击后：

<li class="account-tab-account on">密码登录</li>
#app > div > div.account-body-tabs > ul.tab-start > li.account-tab-account.on
//*[@id="app"]/div/div[1]/ul[1]/li[2]
...
<div class="tc-fg-item" aria-label="拖动下方滑块完成拼图" alt="拖动下方滑块完成拼图" style="position: absolute; background-image: url(&quot;https://turing.captcha.qcloud.com/cap_union_new_getcapbysig?img_index=0&amp;image=0261090000add80000000015022544704a53&amp;sess=s03nadKDGiVAF055fELSJ_2Up-mWgQCfn2quSFgehodZ5j4yHjsat-gjd50ajRf6-rHJeq7C-GU2wEti7rRTimYFfQf7b7XUSilj2AR0k_Ri0jtFY4HlAFw1TYGLJEIY23pcm9KIuyqncMQ78jFJgYPzJ2CzAKZkmGoW5eKPNSYBgQJBF8tkMXAmw2cr3gjOHmIPhbdCI_mSXPRGVKMXYkNI5R-5uGpvjbXmk-oW1-E-5pZSTQSDQ0KnMmphOAVnveLhj0vxEzXZgFuSOqtGBqvfvIQRsaliWpmSiAhGSgd3SiV-xNh101vIcPdRvTFmp6TW13gAWlv2Y_7AgCJNmFyWjepo8hqAoSjWhO5oBSmi39u0HB8Rkj9fLk756DbYvni-YEV-cLkaBDwRJFizjPref1SdiJf88iaVRLZszNX6S3Oq803Hf-Rw**&quot;); background-position: -57.9167px -202.708px; background-size: 282.137px 256.488px; width: 49.6429px; height: 49.6429px; left: 20.6845px; top: 60.8125px; z-index: 1; cursor: pointer; opacity: 1;"></div>
selector：#tcOperation > div:nth-child(9)
xpath：//*[@id="tcOperation"]/div[9]

滑动控件：

<div class="tc-fg-item tc-slider-normal" aria-label="拖动下方滑块完成拼图" alt="拖动下方滑块完成拼图" style="left: 18.6161px; top: 166.304px; z-index: 2; width: 53.7798px; height: 28.9583px; line-height: 28.9583px; background-color: rgb(65, 190, 87); box-shadow: rgba(65, 190, 87, 0.5) 0px 0px 4.1369px 0.41369px; cursor: pointer; opacity: 1;"><i class="tc-blank-text">&amp;nbsp;</i><img alt="slider" src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAACgAAAAcAgMAAABuexVFAAAACVBMVEUAAADCwsL9/f1P0DqbAAAAAXRSTlMAQObYZgAAAB1JREFUGNNjCGVgYGANABKhyMwoEHMBkIgaZWIwAdyJJQnaJRg5AAAAAElFTkSuQmCC" class="tc-slider-bg unselectable" style="width: 15.3656px; height: 10.756px;"></div>
selector：#tcOperation > div.tc-fg-item.tc-slider-normal
xpath：//*[@id="tcOperation"]/div[7]

背景(包括所有元素)：

<div class="tc-bg-img unselectable" id="slideBg" style="position: absolute; background-image: url(&quot;https://turing.captcha.qcloud.com/cap_union_new_getcapbysig?img_index=1&amp;image=0261090000add80000000015022544704a53&amp;sess=s03nadKDGiVAF055fELSJ_2Up-mWgQCfn2quSFgehodZ5j4yHjsat-gjd50ajRf6-rHJeq7C-GU2wEti7rRTimYFfQf7b7XUSilj2AR0k_Ri0jtFY4HlAFw1TYGLJEIY23pcm9KIuyqncMQ78jFJgYPzJ2CzAKZkmGoW5eKPNSYBgQJBF8tkMXAmw2cr3gjOHmIPhbdCI_mSXPRGVKMXYkNI5R-5uGpvjbXmk-oW1-E-5pZSTQSDQ0KnMmphOAVnveLhj0vxEzXZgFuSOqtGBqvfvIQRsaliWpmSiAhGSgd3SiV-xNh101vIcPdRvTFmp6TW13gAWlv2Y_7AgCJNmFyWjepo8hqAoSjWhO5oBSmi39u0HB8Rkj9fLk756DbYvni-YEV-cLkaBDwRJFizjPref1SdiJf88iaVRLZszNX6S3Oq803Hf-Rw**&quot;); background-position: 0px 0px; background-size: 100%; width: 278px; height: 198.571px; left: 0px; top: 0px; background-repeat: no-repeat; overflow: hidden; z-index: 1; opacity: 1;"></div>
selector：#slideBg
xpath：//*[@id="slideBg"]
